...
class __TwigTemplate_4b02eb9949652be523a6d719d33d333138a1591e397be7ed8ffe6391aa7a79c1 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t\t\t\t\t\t\t<span></span>
\t\t\t\t\t\t\t\t\t\t\t\t\t</i>
\t\t\t\t\t\t\t\t\t\t\t\t\t<span class=\"menu-text\">Events Participations</span>
\t\t\t\t\t\t\t\t\t\t\t\t\t<i class=\"menu-arrow\"></i>
\t\t\t\t\t\t\t\t\t\t\t\t</a>
\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"menu-submenu\">
\t\t\t\t\t\t\t\t\t\t\t\t\t<i class=\"menu-arrow\"></i>
...
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<span></span>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</i>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<span class=\"menu-text\">Table Participations</span>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</a>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t</li>
\t\t\t\t\t\t\t\t\t\t\t\t\t</ul>
\t\t\t\t\t\t\t\t\t\t\t\t</div>
...
\t\t\t\t\t\t\t\t";
    ...
    {
        return array (  1328 => 824,  1318 => 823,  1303 => 1104,  1295 => 1099,  1286 => 1093,  1282 => 1092,  1278 => 1091,  1011 => 826,  1009 => 823,  897 => 714,  884 => 704,  871 => 694,  858 => 684,  845 => 674,  830 => 662,  383 => 218,  369 => 206,  356 => 195,  345 => 187,  331 => 175,  318 => 164,  307 => 156,  293 => 144,  220 => 73,  205 => 60,  195 => 59,  182 => 53,  176 => 50,  172 => 49,  168 => 48,  164 => 47,  156 => 42,  152 => 41,  148 => 40,  140 => 35,  131 => 29,  126 => 26,  116 => 25,  97 => 21,  85 => 1109,  83 => 59,  78 => 56,  76 => 25,  69 => 21,  47 => 1,);
    }
...
\t\t\t\t\t\t\t\t\t\t\t\t\t<ul class=\"menu-subnav\">
\t\t\t\t\t\t\t\t\t\t\t\t\t\t<li class=\"menu-item\" aria-haspopup=\"true\">
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<a href=\"{{ path('participate_event_index') }}\" class=\"menu-link\">
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<i class=\"menu-bullet menu-bullet-dot\">
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<span></span>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</i>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<span class=\"menu-text\">Table Participations</span>
